...
| Setting | Island diorama on soft mint water (Komachi uses a calm pastel blue since 2026-09-17) | Organic coastline from a seeded curve: sandy beaches, rocky lips, grassy cliffs, one pier; cream cliff sides floating on mint |
...
| Japanese identity | Kawara tile roofs, hip-and-gable forms, block walls and gates, noren, chōchin, vertical signboards, 止まれ marks, post boxes, kōban, hokora, laundry on balconies, pruned pines and bamboo | Phase 4.8 parts in `kit.js` and `world.js`. Three extra swatches: `kawara`, `kawara2` (grey-blue tiles) and `indigo` (noren) |
| Landmark | Sunken subway entrance with a curved sage roof, railings, bench, vending machine | Komachi Station: a stairwell under an open pavilion with a hipped kawara roof, station name board, clock and paper lamps; benches with a 駅名標 board, pastel vending machines, a line-mark pillar and a kōban |
