...
const RES_KEYS = ['id', 'name', 'wake', 'workStart', 'workEnd', 'commuteH', 'hasCar', 'hasBike', 'commuter', 'homemaker', 'lastWorkDay', 'lunched', 'skin', 'shirt', 'pants', 'hair', 'hat', 'hatColor', 'bag', 'bagColor', 'carColor', 'carKind', 'arrivedDay', 'needs', 'carOrdered'];
